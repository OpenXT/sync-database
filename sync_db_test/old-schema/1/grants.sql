...
grant select on device_user    to &&sync_admin_user;
...
grant select on user_          to &&sync_admin_user;
...
grant select on device_user    to &&sync_license_user;
...
grant select on user_          to &&sync_license_user;
...
grant select on device_user    to &&sync_server_user;
...
grant select on user_          to &&sync_server_user;
