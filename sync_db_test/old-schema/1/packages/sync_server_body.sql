...
create or replace package body sync_server as
    ...
    -- FIXME: should be shared with sync_admin
    ...
    begin
        -- FIXME: temporary solution to avoid duplicating sync_admin code
    ...
    begin
        ...
        -- FIXME: Assumes license daemon and sync-server are in same time zone?
