...
create or replace package sync_error as
    ...
    device_user_exists          constant number := -20024;
    device_user_not_found       constant number := -20023;
    user_name_required          constant number := -20025;
    user_name_too_long          constant number := -20026;
    user_not_found              constant number := -20027;
    user_required               constant number := -20028;
    ...
    device_user_has_vm_inst     constant number := -20045;
    user_has_vm_inst            constant number := -20046;
    ...
    device_user_already_removed constant number := -20050;
    device_user_not_removed     constant number := -20051;
    device_user_removed         constant number := -20052;
    user_already_removed        constant number := -20053;
    user_not_removed            constant number := -20054;
    user_removed                constant number := -20055;
    ...
    removed_device_user_exists  constant number := -20059;
