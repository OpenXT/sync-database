...
(
    ...
    shared_secret       varchar2(32)                       not null,
...
-- encryption_key is a hex string, so 128 hex characters is a 512 bit key.
alter table disk
...
(
    ...
    device_uuid       varchar2(36)  not null,
    vm_uuid           varchar2(36)  not null,
    vm_instance_name  varchar2(200) not null,
...
-- vm_instance_ak1 is needed for the foreign key to vm.
